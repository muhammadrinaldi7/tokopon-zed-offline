<div class="p-6 bg-[#f7f7f7] min-h-screen">
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.05)] overflow-hidden">
        <div class="p-4 border-b border-gray-100 bg-gray-50/50 flex justify-between items-center">
            ...
            <div class="relative">
                <input type="text" wire:model.live.debounce.300ms="search" placeholder="Cari No Order / Pelanggan / Sales..." 
                            ...
                            <td class="px-5 py-3">
                                ...
                                <div class="mt-2 text-[10px] text-gray-500 leading-tight">
                                    @foreach($order->items as $item)
                                        ...
                                        @endphp
                                        <div class="truncate w-40 sm:w-48" title="{{ $name }}">{{ $name }} ({{ $item->qty }}x)</div>
                                    @endforeach
                                </div>
                            </td>
                            <td class="px-5 py-3">
