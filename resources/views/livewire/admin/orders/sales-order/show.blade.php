                        ...
                        @foreach ($dpInvoices as $idx => $dpInv)
                            ...
                            <div class="flex items-center gap-16">
                                ...
                                <div id="node-dp-inv-{{ $idx }}"
                                    ...
                                    style="z-index: 10;">
                                    <div class="text-[10px] font-bold text-emerald-600 uppercase tracking-wider mb-1">
                                    ...
                                    <div class="text-[10px] text-gray-500">{{ $dpInv->created_at->format('d/m/Y H:i') }}
                                    </div>
                                </div>
                                ...
                                @if ($dpRec)
                                    ...
                                    <div id="node-dp-rec-{{ $idx }}"
                                        ...
                                        style="z-index: 10;">
                                        <div class="text-[10px] font-bold text-teal-600 uppercase tracking-wider mb-1">
                                            Penerimaan UM</div>
                        ...
                        @if ($srDoc)
                            ...
                            <div class="relative group" id="node-sr" style="z-index: 10;">
                                <div
                                    ...
                                    <div class="text-[10px] font-bold text-blue-600 uppercase tracking-wider mb-1">Sales
                                        Receipt (Lunas)</div>
                                    <div class="text-[10px] font-semibold text-blue-800 mb-1">{{ $srDoc->doc_number }}
                                    </div>
                                    <div class="text-xs font-bold text-gray-800 mb-1">Rp
                                        {{ number_format($srDoc->amount, 0, ',', '.') }}</div>
                                    <div class="text-[10px] text-gray-500">
                ...
                <div class="space-y-3 text-sm">
                    ...
                    <div class="mt-4 bg-gray-50 rounded-xl p-4 border border-gray-200">
                        ...
                        <div class="flex justify-between text-gray-500 border-t border-gray-200 pt-1 mt-1">
                            ...
                            <span class="font-black text-rose-500">Rp
                ...
                <form wire:submit="saveDp" class="p-6 space-y-4">
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5">Nominal DP
                            Dibayar (Rp) *</label>
                        <input type="number" wire:model="dp_amount" max="{{ $this->getRemainingBalance() }}"
