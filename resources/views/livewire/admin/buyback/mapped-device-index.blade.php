<div>
    <div class="flex items-center justify-between mb-8">
        ...
        <div class="flex items-center gap-3">
            <button wire:click="exportTemplate" wire:loading.attr="disabled"
                ...
                <svg wire:loading.remove wire:target="exportTemplate" class="w-4 h-4" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                <svg wire:loading wire:target="exportTemplate" class="animate-spin w-4 h-4" fill="none"
                    viewBox="0 0 24 24">
    ...
    <div
        class="bg-white rounded-2xl shadow-sm border border-neutral-100-sm border border-gray-100 overflow-hidden mb-6">
        <div
            class="p-4 border-b border-gray-100 bg-gray-50/50 flex flex-col xl:flex-row gap-4 items-center justify-between">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                @forelse($tiers as $tier)
                    <div
                        class="group relative bg-white rounded-2xl border border-gray-100 hover:border-blue-200 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden flex flex-col">
                        <!-- Decorative top gradient -->
                        <div
                            class="h-2 w-full bg-gradient-to-r from-[#1c69d4] to-[#7C74F0] opacity-80 group-hover:opacity-100 transition-opacity">
                        </div>

                        <div class="p-5 flex-1 flex flex-col">
                            <div class="flex justify-between items-start mb-4">
                                <div
                                    class="w-12 h-12 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center group-hover:scale-110 group-hover:bg-blue-100 transition-all duration-300">
                                ...
                                <span
                                    class="inline-flex items-center gap-1.5 px-3 py-1 bg-emerald-50 text-emerald-700 rounded-full text-xs font-bold border border-emerald-100">
                                    {{ $tier->devices_count }} Perangkat
                                </span>
                            </div>

                            <h3
                                class="text-xl font-bold text-gray-900 mb-1 group-hover:text-[#1c69d4] transition-colors">
                                {{ $tier->name }}</h3>
                ...
                @empty
                    <div
                        class="col-span-full py-16 flex flex-col items-center justify-center bg-gray-50/50 rounded-2xl border border-dashed border-gray-200">
                        ...
                        <p class="text-sm text-gray-500 max-w-sm text-center">Silakan buat tier buyback terlebih dahulu
                            sebelum me-mapping perangkat.</p>
                    </div>
                @endforelse
            </div>
        </div>
    ...
    <div x-show="$wire.showImportModal" class="fixed inset-0 z-50 overflow-y-auto" style="display: none;">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div x-show="$wire.showImportModal" x-transition:enter="ease-out duration-300"
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500 mb-4">
                                    Unggah file .xlsx hasil export untuk melakukan update massal mapping tier perangkat
                                    beserta harganya.
                                </p>

                                <form wire:submit="importExcel">
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium text-gray-700 mb-2">Pilih File Excel
                                            (.xlsx)</label>
                                    ...
                                    <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                                        <button type="submit" wire:loading.attr="disabled"
                                            ...
                                            <svg wire:loading wire:target="importExcel"
