<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <form wire:submit.prevent="save" class="p-6 space-y-5">
            ...
            <div class="bg-blue-50/50 rounded-xl border border-blue-100 p-5 space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div class="md:col-span-1">
                        ...
                        <select wire:model.live="target_business_unit_id" class="w-full rounded-lg border-blue-200 bg-white py-2.5 text-blue-900 focus:ring-blue-500 focus:border-blue-500 text-sm shadow-sm">
                    ...
                    <div class="md:col-span-2">
                        <label class="block text-sm font-bold text-blue-900 mb-1.5">Pilih SKU Produk (Ketik untuk mencari)</label>
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <input type="text" wire:model.live.debounce.300ms="searchProduct" @focus="open = true" @click.away="open = false" 
                                placeholder="Misal: iPhone 15 Bekas..." 
                            ...
                            @if(!empty($productsAccurateList))
                                <div x-show="open" class="absolute z-10 w-full bg-white border border-gray-200 rounded-xl shadow-xl max-h-60 overflow-y-auto mt-2 py-1">
                                    @foreach($productsAccurateList as $prod)
                                        <div wire:click="selectProduct({{ $prod->id }})" @click="open = false" 
                                            ...
                                            <div class="text-xs text-gray-500 mt-0.5 flex gap-2">
                                                <span class="bg-gray-100 text-gray-600 px-1.5 py-0.5 rounded font-mono">{{ $prod->item_no }}</span>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <select wire:model="brand_id"
                            class="w-full rounded-lg border-gray-200 bg-gray-50 py-2.5 focus:ring-[#1c69d4] focus:border-[#1c69d4] text-sm text-gray-600 pointer-events-none" tabindex="-1">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="model_name" placeholder="Pilih produk dari Accurate di atas..."
                            class="w-full rounded-lg border-gray-200 bg-gray-50 py-2.5 focus:ring-[#1c69d4] focus:border-[#1c69d4] text-sm text-gray-600 pointer-events-none" tabindex="-1">
                        @error('model_name')
                            <span class="text-xs text-rose-500 mt-1 block">{{ $message }}</span>
                        @enderror
            ...
            {{-- Status Aktif --}}
            <div class="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-100 mt-4 transition-all hover:bg-gray-100">
                ...
                <div class="flex flex-col">
                    ...
                    <p class="text-xs text-gray-500">Jika dinonaktifkan, model HP ini tidak akan bisa dipilih oleh staf saat Buyback.</p>
                </div>
            </div>
