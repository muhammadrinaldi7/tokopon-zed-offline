<div>
    <div class="mb-6">
        <a href="{{ route('admin.qc.returns') }}" wire:navigate class="inline-flex items-center text-sm font-medium text-slate-500 hover:text-slate-800 transition-colors mb-2">
