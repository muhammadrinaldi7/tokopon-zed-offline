<div>
    <div class="mb-6">
        ...
        <p class="text-gray-500 text-sm mt-1">Pindai atau ketik IMEI/SN untuk melihat lokasi gudang dan status barang.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="p-6">
                    <form wire:submit="search">
                        ...
                        <div class="mb-4">
                            ...
                            @error('keyword') <span class="text-xs text-red-500 mt-1 block text-center">{{ $message }}</span> @enderror
                        </div>

                        <button type="submit" class="w-full bg-neutral-800 hover:-translate-y-1 hover:shadow-md transition-all duration-300 text-white font-medium py-3 px-4 rounded-lg transition-colors flex justify-center items-center gap-2">
        ...
        <div class="md:col-span-2">
            @if($hasSearched)
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden h-full">
                        <div class="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50">
                            ...
                            @php
                                ...
                                $colorClass = $statusColors[$result->status] ?? 'bg-gray-100 text-gray-800 border-gray-200';
                            @endphp
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <p class="text-xl font-mono font-bold text-gray-900">{{ $result->serial_number }}</p>
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    @else
                                        <p class="text-lg font-medium text-gray-500 italic">Nama produk tidak ditemukan di katalog lokal</p>
                                    @endif
                                </div>
                                
                                <div class="bg-blue-50 rounded-lg p-4 md:col-span-2 border border-blue-100 flex items-start gap-3">
                                    <div class="mt-1">
                ...
                @else
                    <div class="bg-white rounded-xl shadow-sm border border-red-200 overflow-hidden h-full flex flex-col items-center justify-center p-8 text-center">
                        <div class="w-20 h-20 rounded-full bg-red-50 text-red-500 flex items-center justify-center mb-4">
                        ...
                        <p class="text-gray-500 max-w-md">
                            ...
                            Pastikan Anda sudah menekan "Sync Serial Number" jika ini adalah barang baru dari Accurate.
                        </p>
                        <button type="button" onclick="document.getElementById('keyword').focus()" class="mt-6 px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg font-medium transition-colors text-sm">
                            Coba Scan Lagi
                        </button>
                    </div>
                @endif
            @else
                <div class="bg-gray-50 rounded-xl border border-dashed border-gray-300 h-full flex flex-col items-center justify-center p-8 text-center min-h-[300px]">
