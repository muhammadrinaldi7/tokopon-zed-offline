                    ...
                    <div
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            ...
                            <a href="{{ route('admin.qc.device-search') }}" wire:navigate
                                ...
                                class="w-full aspect-square p-3 bg-white/80 hover:bg-white text-gray-800 font-semibold rounded-2xl shadow-sm border border-white/50 transition-all duration-200 flex flex-col items-center justify-center gap-2 group">
                                <div
                                    class="w-12 h-12 rounded-xl bg-emerald-100/50 flex items-center justify-center text-emerald-500 group-hover:scale-110 transition-transform">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                ...
                                <span class="block text-[11px] sm:text-xs text-center leading-tight">Periksa
                                    Perangkat</span>
                            </a>
        ...
        @if (auth()->user()->getActiveBusinessUnitId() == 2)
            @can('monitoring-kasir')
                ...
                <div wire:click="navigateToMonitoringKasir"
                    ...
                    <div>
                        <h1 class="text-2xl ">Monitoring <br> Kasir</h1>
                        <p class="text-neutral-500 text-sm mt-3 line-clamp-2">Rekapitulasi penjualan per kasir
                        </p>
                    </div>
                </div>
            @endcan
