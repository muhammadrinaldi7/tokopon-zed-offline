<div class="max-w-7xl mx-auto p-2  md:p-6 min-h-screen" x-data="{ step: 1 }" x-cloak>
    ...
    <div class="mt-16 max-w-7xl mx-auto">
        ...
        @php
            $isStep1Valid = !empty($selected_model_name);
        @endphp
    ...
    <div x-show="step === 2" x-transition:enter="transition ease-out duration-300 delay-100"
        ...
        <div x-data="{ qcStep: 0 }"
            ...
            <div class="mb-6 relative">
                ...
                <div class="mt-2 text-xs font-bold text-neutral-500 text-right">Tahap <span x-text="qcStep"></span>
            ...
            <div x-show="qcStep === 0" x-transition.opacity class="space-y-6">
                <div class="space-y-2">
                    ...
                    <input type="text" wire:model.live.debounce.500ms="imei" placeholder="Scan atau ketik IMEI..."
            ...
            <div x-show="qcStep === {{ $maxQcStep }}" x-transition.opacity style="display: none;"
                ...
                <div class="mt-4">
                    ...
                    <div x-show="$wire.qc_verdict === 'conditional'"
                        ...
                        <p class="text-sm text-amber-700/80 font-medium whitespace-pre-line" x-text="$wire.qc_notes">
                        </p>
                    </div>
                    ...
                    <div x-show="$wire.qc_verdict === 'fail'"
                        ...
                        <p class="text-sm text-rose-700/80 font-medium whitespace-pre-line" x-text="$wire.qc_notes">
                        </p>
                    </div>
            ...
            <div
                ...
                <div class="w-full md:w-auto flex justify-end">
                    ...
                    <button x-show="qcStep === {{ $maxQcStep }}" type="button"
                        @click="$wire.qc_verdict === 'fail' ? $wire.submit() : step = 3" :disabled="!$wire.qc_verdict"
                        class="px-6 py-3 rounded-xl font-bold transition-all flex items-center justify-center gap-2 w-full md:w-auto"
                                ...
                                <label class="cursor-pointer block ">
                                    ...
                                    @else
                                        <input type="radio" name="{{ $category }}"
                                            value="{{ $rule['key'] }}"
                                            wire:model.live="selected_rules.{{ $category }}" class="peer hidden">
                                    @endif
                                ...
                                <div class="flex flex-col gap-1 md:col-span-2">
                                    ...
                                    <div class="relative flex items-center justify-center w-full">
                                        <label for="foto_ktp"
                                            ...
                                            <input id="foto_ktp" @change="customCompressHandler($event, 'foto_ktp')"
                                                type="file" accept="image/*" required class="hidden" />
                                        </label>
                                    </div>
                                    @error('foto_ktp')
            ...
            <div class="space-y-6 relative">
                <div class="bg-neutral-50 rounded-3xl p-6">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div class="flex flex-col gap-1">
                            <span class="text-[10px] font-black text-neutral-400 uppercase tracking-widest">Kategori /
                                Proyek</span>
