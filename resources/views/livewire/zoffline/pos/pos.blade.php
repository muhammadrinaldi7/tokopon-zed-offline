        ...
        <div class="max-w-7xl mx-auto min-h-full flex flex-col">
            ...
            <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-6 rounded-r-lg shadow-sm">
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-bold text-yellow-800">Perhatian: Shift Kasir Belum Dibuka!</h3>
                        <div class="mt-1 text-sm text-yellow-700">
                            <p>Anda belum membuka shift kasir untuk hari ini. Disarankan untuk memasukkan modal awal sebelum menerima pembayaran.</p>
                        </div>
                        <div class="mt-2">
                            <a href="{{ route('zoffline.pos.open-shift') }}" class="inline-flex items-center text-sm font-bold text-yellow-800 hover:text-yellow-900 bg-yellow-200 hover:bg-yellow-300 px-3 py-1.5 rounded-lg transition-colors">
