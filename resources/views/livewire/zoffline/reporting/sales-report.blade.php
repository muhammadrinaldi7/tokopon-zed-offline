<div class="p-6 bg-[#f7f7f7] min-h-screen">
    ...
    <div class="flex flex-col items-start mb-6 gap-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-3 w-full">
            ...
            <div x-data="{
                ...
                <div @click="open = !open" class="w-full flex items-center justify-between cursor-pointer select-none">
                    ...
                    <div class="flex items-center gap-1 shrink-0 ml-1">
                        <button type="button" x-show="selected" @click.stop="selectVendor('')"
                            class="text-gray-400 hover:text-gray-600 p-0.5" title="Reset filter vendor">
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-100"
                    ...
                    <div class="px-2 pb-2 border-b border-gray-100">
                        <div class="relative">
                            <input x-model="search" x-ref="vendorSearchInput" @keydown.escape="open = false"
                                type="text" placeholder="Ketik cari vendor..."
                    ...
                    <div class="overflow-y-auto flex-1 max-h-56 divide-y divide-gray-50 text-xs">
                        ...
                        <div x-show="filteredVendors.length === 0 && search"
                ...
                <div @click="open = !open"
                    ...
                    <div class="flex items-center gap-1 shrink-0 ml-1">
                        <button type="button" x-show="selected && selected.length > 0"
                            @click.stop="clearSelection()" class="text-gray-400 hover:text-gray-600 p-0.5"
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-100"
                    ...
                    <div class="px-2 pb-2 border-b border-gray-100">
                        <div class="relative">
                            <input x-model="search" x-ref="projectSearchInput" @keydown.escape="open = false"
                                type="text" placeholder="Ketik cari proyek..."
                                class="w-full pl-8 pr-3 py-1.5 text-xs bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-[#1c69d4] focus:border-[#1c69d4]"
                    ...
                    <div class="overflow-y-auto flex-1 max-h-56 divide-y divide-gray-50 text-xs">
                        <template x-for="p in filteredProjects" :key="p">
                            <label
                                class="px-3 py-2 cursor-pointer hover:bg-blue-50 flex items-center gap-2 transition-colors">
                        ...
                        <div x-show="filteredProjects.length === 0 && search"
                            class="px-3 py-4 text-center text-gray-400 italic">
            ...
            <div
                class="flex items-center gap-2 col-span-1 {{ $dateRange === 'custom' ? 'lg:col-span-6' : 'lg:col-span-2' }}">
                @if ($activeTab === 'transactions')
                    ...
                    <button wire:click="exportCsvOpsi3" wire:loading.attr="disabled"
                        ...
                        <svg wire:loading.remove wire:target="exportCsvOpsi3" class="w-4 h-4 shrink-0 text-slate-300"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">
                            </path>
                        </svg>
                        <svg wire:loading wire:target="exportCsvOpsi3"
                    ...
                    <button wire:click="exportExcelOpsi3" wire:loading.attr="disabled"
                        ...
                        <svg wire:loading.remove wire:target="exportExcelOpsi3"
                            class="w-4 h-4 shrink-0 text-emerald-200" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">
                            </path>
                        </svg>
                        <svg wire:loading wire:target="exportExcelOpsi3"
                            class="animate-spin w-4 h-4 text-white shrink-0" xmlns="http://www.w3.org/2000/svg"
                            fill="none" viewBox="0 0 24 24">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor"
                                stroke-width="4"></circle>
                ...
                @else
                    ...
                    <button wire:click="exportVendorCsv" wire:loading.attr="disabled"
                        class="flex-1 flex items-center justify-center gap-1.5 bg-slate-700 hover:bg-slate-800 disabled:opacity-75 disabled:cursor-wait text-white text-xs font-bold py-2 px-3 rounded-xl shadow-sm transition-colors h-full min-h-10.5">
                        <svg wire:loading.remove wire:target="exportVendorCsv" class="w-4 h-4 shrink-0 text-slate-300"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">
                            </path>
                        </svg>
                        <svg wire:loading wire:target="exportVendorCsv"
                            class="animate-spin w-4 h-4 text-white shrink-0" xmlns="http://www.w3.org/2000/svg"
                            fill="none" viewBox="0 0 24 24">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor"
                                stroke-width="4"></circle>
                    ...
                    <button wire:click="exportVendorExcel" wire:loading.attr="disabled"
                        class="flex-1 flex items-center justify-center gap-1.5 bg-emerald-600 hover:bg-emerald-700 disabled:opacity-75 disabled:cursor-wait text-white text-xs font-bold py-2 px-3 rounded-xl shadow-sm transition-colors h-full min-h-10.5">
                        <svg wire:loading.remove wire:target="exportVendorExcel"
                            class="w-4 h-4 shrink-0 text-emerald-200" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">
                        ...
                        <svg wire:loading wire:target="exportVendorExcel"
                            class="animate-spin w-4 h-4 text-white shrink-0" xmlns="http://www.w3.org/2000/svg"
                            fill="none" viewBox="0 0 24 24">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor"
                                stroke-width="4"></circle>
    ...
    @if ($activeTab === 'transactions')
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.05)]">
                ...
                <h3 class="text-xl font-bold text-gray-700">Rp {{ number_format($summary['gross'], 0, ',', '.') }}
                </h3>
            </div>
            <div
                ...
                <h3 class="text-xl font-black text-[#1c69d4]">Rp {{ number_format($summary['net'], 0, ',', '.') }}
                </h3>
            </div>
        </div>
    @else
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.05)]">
                ...
                <h3 class="text-xl font-black text-gray-800">{{ number_format($totalVendorCount) }} <span
                        class="text-sm font-medium text-gray-400">Supplier/Vendor</span></h3>
            </div>
            <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.05)]">
                <p class="text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Total Unit Terjual</p>
                <h3 class="text-xl font-bold text-gray-700">{{ number_format($totalVendorQty) }} <span
                        class="text-sm font-medium text-gray-400">Unit / Pcs</span></h3>
            </div>
            <div
                class="bg-white rounded-2xl p-5 border border-gray-100 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.05)] relative overflow-hidden">
                ...
                <h3 class="text-xl font-black text-emerald-600">Rp {{ number_format($totalVendorNet, 0, ',', '.') }}
                </h3>
            </div>
        </div>
    @endif
        ...
        @if ($activeTab === 'transactions')
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr
                            class="bg-white border-b border-gray-100 text-[11px] uppercase tracking-wider text-gray-500">
                        ...
                        @forelse($orders as $order)
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                <td class="px-5 py-3">
                                    ...
                                    <p class="text-[11px] text-gray-500 mt-0.5 font-mono">{{ $order->order_number }}
                                    </p>
                                ...
                                <td class="px-5 py-3">
                                    <span
                                        class="px-2 py-1 bg-gray-100 text-gray-700 rounded-md text-[11px] font-medium">
                                        {{ $order->shipping_address_snapshot['store'] ?? 'Unknown' }}
                                    </span>
                                </td>
                                <td class="px-5 py-3">
                                    @php
                                        $projects = collect($order->items)
                                            ->map(function ($item) {
                                ...
                                <td class="px-5 py-3 text-right">
                                    ...
                                    <p class="text-sm font-black text-[#1c69d4]">Rp
                                        {{ number_format($net, 0, ',', '.') }}</p>
                                </td>
                            </tr>
                        @empty
                            <tr>
                        ...
                        @forelse($vendorSummary as $index => $vnd)
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                ...
                                <td class="px-5 py-3">
                                    <div class="flex items-center gap-2">
                                        <div
                                            class="w-8 h-8 rounded-lg bg-blue-50 text-[#1c69d4] flex items-center justify-center font-bold text-xs shrink-0">
                                            {{ strtoupper(substr($vnd['vendor_name'], 0, 2)) }}
                                        </div>
                                        <div>
                                            <p class="text-xs font-bold text-gray-800">{{ $vnd['vendor_name'] }}</p>
                                            <span
                                                class="text-[10px] text-gray-400 font-medium">{{ count($vnd['branches']) }}
                                                Cabang Aktif</span>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-5 py-3">
                                    <div class="flex flex-wrap gap-1.5 max-w-sm">
                                        @foreach ($vnd['branches'] as $bName => $bData)
                                            <span
                                                class="inline-flex items-center gap-1 px-2 py-0.5 bg-gray-100 text-gray-700 rounded-md text-[10px] font-medium"
                                                title="Gross: Rp {{ number_format($bData['gross']) }}">
                                                <span class="font-semibold">{{ $bName }}:</span>
                                                <span
                                                    class="text-blue-600 font-bold">{{ number_format($bData['qty']) }}x</span>
                                                <span class="text-gray-500 text-[9px]">(Rp
                                                    {{ number_format($bData['net'] / 1000000, 1) }}M)</span>
                                            </span>
                                        @endforeach
                                    </div>
                                </td>
                                <td class="px-5 py-3 text-center text-xs font-semibold text-gray-700">
                                    {{ number_format($vnd['qty']) }}</td>
                                <td class="px-5 py-3 text-right text-xs text-gray-700">Rp
                                    {{ number_format($vnd['gross'], 0, ',', '.') }}</td>
                                <td class="px-5 py-3 text-right text-xs text-red-500">Rp
                                    {{ number_format($vnd['discount'], 0, ',', '.') }}</td>
                                <td class="px-5 py-3 text-right text-xs font-black text-[#1c69d4]">Rp
                                    {{ number_format($vnd['net'], 0, ',', '.') }}</td>
                                <td class="px-5 py-3 text-center text-xs font-semibold text-gray-700">
                                    {{ number_format($vnd['transaction_count']) }} Nota</td>
                            </tr>
                        @empty
                            <tr>
    ...
    @if ($showSyncModal)
        <div
            ...
            <div
                class="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] flex flex-col overflow-hidden border border-gray-100 animate-in fade-in zoom-in duration-150">
                ...
                <div class="px-6 py-4 bg-slate-900 text-white flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-400">Tarik dokumen Sales Return untuk menyeimbangkan laporan
                                penjualan POS</p>
                        </div>
                    </div>
                    <button wire:click="closeSyncModal"
                ...
                <div class="p-4 bg-slate-50 border-b border-gray-200">
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-3 items-end">
                        <div class="md:col-span-3">
                            ...
                            <select wire:model="syncBuCode"
                                class="w-full text-xs font-semibold rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 bg-white py-2">
                        ...
                        <div class="md:col-span-3">
                            ...
                            <input type="date" wire:model="syncStartDate"
                                class="w-full text-xs rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 bg-white py-1.5 text-center">
                        </div>

                        <div class="md:col-span-3">
                            <label class="block text-xs font-bold text-gray-600 mb-1">Sampai Tanggal</label>
                            <input type="date" wire:model="syncEndDate"
                                class="w-full text-xs rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 bg-white py-1.5 text-center">
                        </div>
                        ...
                        <div class="md:col-span-3">
                            <button wire:click="loadSyncPreview" wire:loading.attr="disabled"
                                ...
                                <svg wire:loading.remove wire:target="loadSyncPreview" class="w-4 h-4" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                                </svg>
                                <svg wire:loading wire:target="loadSyncPreview"
                                    class="animate-spin w-4 h-4 text-white" xmlns="http://www.w3.org/2000/svg"
                                    fill="none" viewBox="0 0 24 24">
                ...
                @if ($syncResultMessage)
                    <div
                        class="p-3 mx-4 mt-3 rounded-xl text-xs font-semibold flex items-center gap-2 {{ $syncResultType === 'success' ? 'bg-emerald-50 text-emerald-800 border border-emerald-200' : 'bg-rose-50 text-rose-800 border border-rose-200' }}">
                ...
                <div class="p-4 flex-1 overflow-y-auto min-h-[300px]">
                    @if ($isSyncLoading)
                        <div class="h-64 flex flex-col items-center justify-center gap-3 text-slate-500">
                            ...
                            <span class="text-xs font-medium">Menghubungi server Accurate Online & memproses
                                data...</span>
                        </div>
                    @elseif ($syncPreviewData)
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
                            <div class="bg-slate-50 p-3 rounded-xl border border-slate-200">
                                <span class="text-[10px] text-slate-500 font-bold uppercase tracking-wider block">Total
                                    di Accurate</span>
                                <span
                                    class="text-lg font-black text-slate-800">{{ $syncPreviewData['summary']['total_count'] }}</span>
                                <span class="text-[10px] text-slate-400 block">Dokumen</span>
                            </div>

                            <div class="bg-emerald-50 p-3 rounded-xl border border-emerald-200">
                                <span
                                    class="text-[10px] text-emerald-700 font-bold uppercase tracking-wider block">Sudah
                                    Ada di POS</span>
                                <span
                                    class="text-lg font-black text-emerald-700">{{ $syncPreviewData['summary']['already_synced_count'] }}</span>
                                <span class="text-[10px] text-emerald-600 block">Tersinkron</span>
                            </div>

                            <div class="bg-amber-50 p-3 rounded-xl border border-amber-200">
                                <span class="text-[10px] text-amber-700 font-bold uppercase tracking-wider block">Belum
                                    Ada di POS</span>
                                <span
                                    class="text-lg font-black text-amber-700">{{ $syncPreviewData['summary']['ready_to_sync_count'] }}</span>
                            ...
                            <div class="bg-indigo-50 p-3 rounded-xl border border-indigo-200">
                                <span
                                    class="text-[10px] text-indigo-700 font-bold uppercase tracking-wider block">Nilai
                                    Pengurang Omset</span>
                                <span class="text-base font-black text-indigo-700 truncate block"
                                    title="Rp {{ number_format($syncPreviewData['summary']['ready_to_sync_total_amount'], 0, ',', '.') }}">
                                    Rp
                                    {{ number_format($syncPreviewData['summary']['ready_to_sync_total_amount'], 0, ',', '.') }}
                                </span>
                        ...
                        <div class="border border-gray-200 rounded-xl overflow-x-auto bg-white shadow-sm">
                            <table class="w-full text-left border-collapse">
                                <thead>
                                    <tr
                                        class="bg-slate-100 text-slate-700 text-[11px] font-bold uppercase border-b border-gray-200">
                                ...
                                <tbody class="divide-y divide-gray-100 text-xs">
                                    @forelse ($syncPreviewData['items'] as $item)
                                        <tr
                                            class="hover:bg-slate-50/80 transition-colors {{ $item['status'] === 'READY_TO_SYNC' ? 'bg-amber-50/20' : '' }}">
                                            <td class="px-3 py-2.5 font-bold text-slate-800">
                                                {{ $item['number'] }}
                                                @if (!empty($item['description']))
                                                    <span
                                                        class="block text-[10px] text-slate-400 font-normal truncate max-w-xs">{{ $item['description'] }}</span>
                                                @endif
                                            </td>
                                            <td class="px-3 py-2.5 text-slate-600 whitespace-nowrap">
                                                {{ $item['trans_date'] }}</td>
                                            <td class="px-3 py-2.5 text-slate-700 font-medium truncate max-w-[150px]">
                                                {{ $item['customer_name'] }}</td>
                                            <td class="px-3 py-2.5 text-slate-600 truncate max-w-[120px]">
                                                {{ $item['branch_name'] }}</td>
                                            <td
                                                class="px-3 py-2.5 text-right font-black text-rose-600 whitespace-nowrap">
                                                ...
                                                @if ($item['status'] === 'ALREADY_SYNCED')
                                                    <span
                                                        ...
                                                        @if (!empty($item['pos_order_number']))
                                                            <span
                                                                class="text-[9px] text-emerald-600 font-normal">({{ $item['pos_order_number'] }})</span>
                                                        @endif
                                                    </span>
                                                @else
                                                    <span
                                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-amber-100 text-amber-800 animate-pulse">
                                                        ★ Siap Ditarik
                                                    </span>
                                                @endif
                                            </td>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6"
                                                class="px-4 py-8 text-center text-slate-400 text-xs italic">
                    ...
                    @else
                        <div class="h-64 flex flex-col items-center justify-center gap-2 text-slate-400">
                            ...
                            <span class="text-xs">Klik tombol <strong>"Cek Data Retur"</strong> untuk memuat daftar
                                retur dari Accurate Online.</span>
                        </div>
                    @endif
                </div>
                ...
                {{-- Modal Footer --}}
                <div
                    class="p-4 bg-slate-50 border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between gap-3">
                    <div class="flex items-center gap-2 text-[11px] text-slate-500">
                        ...
                        <span>Proteksi Data: Sinkronisasi retur hanya memotong omset & HPP laporan, tanpa mengubah stok
                            fisik opname.</span>
                    </div>
                    ...
                    <div class="flex items-center gap-2 w-full sm:w-auto">
                        ...
                        @if ($syncPreviewData && $syncPreviewData['summary']['ready_to_sync_count'] > 0)
                            <button type="button" wire:click="executeSyncReturns" wire:loading.attr="disabled"
                                ...
                                <svg wire:loading.remove wire:target="executeSyncReturns" class="w-4 h-4"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" />
                                </svg>
                                <svg wire:loading wire:target="executeSyncReturns"
                                    class="animate-spin w-4 h-4 text-white" xmlns="http://www.w3.org/2000/svg"
                                    fill="none" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10"
                                        stroke="currentColor" stroke-width="4"></circle>
                                ...
                                <span>Proses Sinkronisasi ({{ $syncPreviewData['summary']['ready_to_sync_count'] }}
                                    Dokumen)</span>
                            </button>
                        @endif
                    </div>
