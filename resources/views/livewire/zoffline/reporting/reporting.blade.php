    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 max-w-7xl mx-auto gap-6 w-full">
        ...
        @can('closing-kasir-report')
            ...
            <div wire:click="navigateToClosingKasir"
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-800">Closing Kasir</h2>
                    <p class="text-neutral-500 text-sm mt-2 line-clamp-2">Riwayat shift dan setoran kasir</p>
                </div>
            </div>
        @endcan

        @can('report-monitoring-kasir')
            <!-- Card: Monitoring Kasir Report -->
            <div wire:click="navigateToMonitoringKasirReport"
                class="w-full h-64 bg-white rounded-2xl relative flex flex-col justify-between overflow-hidden p-6 lg:p-8 group cursor-pointer shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-200 ease-out">
                <div class="rounded-full w-16 h-16 bg-blue-50 flex items-center justify-center text-blue-600">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-800">Laporan Monitoring Kasir</h2>
                    <p class="text-neutral-500 text-sm mt-2 line-clamp-2">Riwayat setoran settlement per kasir</p>
                </div>
            </div>
        @endcan

        <div wire:click="navigateToInvoiceReport"
            class="w-full h-64 bg-white rounded-2xl relative flex flex-col justify-between overflow-hidden p-6 lg:p-8 group cursor-pointer shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-200 ease-out">
            <div class="rounded-full w-16 h-16 bg-indigo-50 flex items-center justify-center text-indigo-600">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
            ...
            <div>
                <h2 class="text-xl font-bold text-gray-800">Laporan Pembayaran</h2>
                <p class="text-neutral-500 text-sm mt-2 line-clamp-2">Ringkasan pembayaran pelanggan</p>
            </div>
        </div>
        ...
        @can('laporan-garansi')
            <div wire:click="navigateToWarranty"
                class="w-full h-64 bg-white rounded-2xl relative flex flex-col justify-between overflow-hidden p-6 lg:p-8 group cursor-pointer shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-200 ease-out">
                <div class="rounded-full w-16 h-16 bg-teal-50 flex items-center justify-center text-teal-600">
                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-800">Laporan Aktivasi Garansi</h2>
