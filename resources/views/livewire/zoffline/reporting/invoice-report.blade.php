<div class="p-6 bg-[#f7f7f7] min-h-screen">
    <div class="flex flex-col  justify-between items-start mb-6 gap-4">
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3">
            ...
            {{-- Export Excel --}}
            <button wire:click="exportExcelOrderPayments" wire:loading.attr="disabled"
                ...
                <svg wire:loading.remove wire:target="exportExcelOrderPayments" class="w-4 h-4" fill="none"
                    stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path>
                </svg>
                <svg wire:loading wire:target="exportExcelOrderPayments" class="animate-spin w-4 h-4 text-white"
                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor"
                        stroke-width="4"></circle>
                    <path class="opacity-75" fill="currentColor"
                ...
                <span wire:loading.remove wire:target="exportExcelOrderPayments">Export Excel</span>
                <span wire:loading wire:target="exportExcelOrderPayments">Memproses...</span>
            </button>
