<div class="min-h-screen bg-gray-50 p-4 md:p-8">
    ...
    @if ($isSaved)
        <div class="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div
                class="relative bg-white rounded-3xl w-full max-w-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] animate-fade-in-up">
                <div class="p-6 md:p-8 overflow-y-auto">
                    ...
                    @if (count($generatedWarranties) > 0)
                        <div class="space-y-6">
                            @foreach ($generatedWarranties as $warranty)
                                <div
                                    class="bg-white rounded-3xl p-6 md:p-8 shadow-sm shadow-blue-900/5 border border-gray-200 relative overflow-hidden">
                                    <!-- Background Decoration -->
                                    <div
                                        class="absolute -right-16 -top-16 w-64 h-64 bg-gradient-to-br {{ $warranty->policy->type === 'addon_warranty' ? 'from-purple-500/10 to-pink-500/10' : 'from-blue-500/10 to-cyan-500/10' }} rounded-full blur-3xl pointer-events-none">
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center gap-4">
                                            <div
                                                class="w-14 h-14 rounded-2xl flex items-center justify-center shadow-sm {{ $warranty->policy->type === 'addon_warranty' ? 'bg-purple-50 text-purple-600' : 'bg-blue-50 text-blue-600' }}">
                                            ...
                                            <div>
                                                <h4 class="text-lg font-black text-gray-900">
                                                    {{ $warranty->policy->name }}</h4>
                                                <div class="flex items-center gap-2 mt-1">
                                                    <span
                                                        class="px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider {{ $warranty->policy->type === 'addon_warranty' ? 'bg-purple-100 text-purple-700' : 'bg-blue-100 text-blue-700' }}">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                                        <div>
                                            ...
                                            <div class="bg-gray-50 rounded-2xl p-4 border border-gray-100 space-y-3">
                                                ...
                                                <div
                                                    class="flex justify-between items-center border-b border-gray-200/60 pb-3">
                                                    <span class="text-sm font-medium text-gray-500">Serial
                                                        Number</span>
                                                    <span
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                                @foreach ($warranty->policy->coverage as $cov)
                                                    <div
                                                        ...
                                                        @else
                                                            <svg class="w-4 h-4 text-rose-400 mt-0.5 shrink-0"
                                                                fill="none" viewBox="0 0 24 24"
                                                                stroke="currentColor">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    @else
                        <div class="bg-amber-50 border border-amber-200 rounded-2xl p-6 text-center">
                            ...
                            <p class="text-sm text-amber-700 mt-1">Sistem tidak menemukan kebijakan garansi default
                                untuk produk ini maupun pembelian asuransi tambahan.</p>
                        </div>
                    @endif
