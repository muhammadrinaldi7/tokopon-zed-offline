<aside :class="(sidebarCollapsed ? 'lg:w-20' : 'lg:w-64') + ' ' + (sidebarOpen ? 'translate-x-0' : '-translate-x-full')"
    ...
    <nav class="flex-1 py-6 px-4 space-y-1.5 overflow-y-auto no-scrollbar overflow-x-hidden">
        ...
        @can('manage-orders')
            <a href="{{ route('admin.customer-deposits.index') }}" wire:navigate
                class="flex items-center gap-3 px-4 py-3 rounded-2xl text-sm transition-colors cursor-pointer {{ request()->routeIs('admin.customer-deposits.*') ? $activeClass : $inactiveClass }}">
                <svg class="w-5 h-5 {{ request()->routeIs('admin.customer-deposits.*') ? $activeIconClass : $inactiveIconClass }}"
                    fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span class="font-medium">Deposit Pelanggan</span>
            </a>
            ...
            <a href="{{ route('admin.orders.issues') }}" wire:navigate
                class="flex items-center gap-3 px-4 py-3 rounded-lg text-sm transition-colors cursor-pointer {{ request()->routeIs('admin.orders.issues') ? $activeClass : $inactiveClass }}">
                <svg class="w-5 h-5 {{ request()->routeIs('admin.orders.issues') ? $activeIconClass : $inactiveIconClass }}"
                    fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z" />
                </svg>
                <span x-show="!sidebarCollapsed" class="whitespace-nowrap transition-opacity">Kendala Pesanan</span><span
                    class="absolute left-full ml-4 px-3 py-1.5 bg-neutral-800 text-white text-xs font-bold rounded-lg opacity-0 pointer-events-none group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all duration-200 whitespace-nowrap shadow-md z-50"
                    x-show="sidebarCollapsed" style="display:none;" x-cloak>Kendala Pesanan</span>
            </a>
        ...
        @can('manage-trade-in')
            ...
            <a href="{{ route('admin.sell-phones.index') }}" wire:navigate
                class="flex items-center gap-3 px-4 py-3 rounded-lg text-sm transition-colors cursor-pointer {{ request()->routeIs('admin.sell-phones.index', 'admin.sell-phones.show') ? $activeClass : $inactiveClass }}">
                <svg class="w-5 h-5 {{ request()->routeIs('admin.sell-phones.index', 'admin.sell-phones.show') ? $activeIconClass : $inactiveIconClass }}"
                    fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
            ...
            <a href="{{ route('admin.sell-phones.issues') }}" wire:navigate
                class="flex items-center gap-3 px-4 py-3 rounded-lg text-sm transition-colors cursor-pointer {{ request()->routeIs('admin.sell-phones.issues') ? $activeClass : $inactiveClass }}">
                <svg class="w-5 h-5 {{ request()->routeIs('admin.sell-phones.issues') ? $activeIconClass : $inactiveIconClass }}"
                    fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        @can('manage-orders')
            <div x-data="{ openWarranty: {{ request()->routeIs('admin.warranty.*') ? 'true' : 'false' }} }">
                ...
                <div x-show="openWarranty && !sidebarCollapsed" style="display: none;" class="pl-12 mt-1 mb-2 space-y-1">
                    ...
                    <a href="{{ route('admin.warranty.pending-activations') }}" wire:navigate
                        class="block px-4 py-2 rounded-lg text-xs transition-colors cursor-pointer {{ request()->routeIs('admin.warranty.pending-activations') ? 'bg-[#1c69d4]/10 text-[#1c69d4] font-bold' : 'text-gray-500 hover:bg-gray-100 hover:text-gray-800 font-medium' }}">
                        Generate Garansi (Gantung)
                    </a>
                </div>
            </div>
        @endcan

        @canany(['manage-qc-templates', 'manage-qc-inspections'])
        ...
        @can('manage-users')
            ...
            <a href="{{ route('admin.users.duplicates') }}" wire:navigate
                class="flex items-center gap-3 px-4 py-3 rounded-lg text-sm transition-colors cursor-pointer {{ request()->routeIs('admin.users.duplicates*') ? $activeClass : $inactiveClass }}">
                <svg class="w-5 h-5 {{ request()->routeIs('admin.users.duplicates*') ? $activeIconClass : $inactiveIconClass }}"
                    fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M8 7v8a2 2 0 002 2h6M8 7V5a2 2 0 012-2h4.586a1 1 0 01.707.293l4.414 4.414a1 1 0 01.293.707V15a2 2 0 01-2 2h-2M8 7H6a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2v-2" />
                </svg>
                <span x-show="!sidebarCollapsed" class="whitespace-nowrap transition-opacity">Duplikat Pengguna</span><span
                    class="absolute left-full ml-4 px-3 py-1.5 bg-neutral-800 text-white text-xs font-bold rounded-lg opacity-0 pointer-events-none group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all duration-200 whitespace-nowrap shadow-md z-50"
                    x-show="sidebarCollapsed" style="display:none;" x-cloak>Duplikat Pengguna</span>
            </a>
        ...
        @can('manage-settings')
            <div class="px-4 mt-8 mb-2" x-show="!sidebarCollapsed">
                <p class="text-[13px] font-bold tracking-[1.5px] text-gray-400 uppercase">Warranty</p>
            </div>

            <a href="{{ route('admin.warranty.policies') }}" wire:navigate
                class="flex items-center gap-3 px-4 py-3 rounded-lg text-sm transition-colors cursor-pointer {{ request()->routeIs('admin.warranty.policies') ? $activeClass : $inactiveClass }}">
                <svg class="w-5 h-5 {{ request()->routeIs('admin.warranty.policies') ? $activeIconClass : $inactiveIconClass }}"
                    fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
                <span x-show="!sidebarCollapsed" class="whitespace-nowrap transition-opacity">Kebijakan
                    Garansi</span><span
                    class="absolute left-full ml-4 px-3 py-1.5 bg-neutral-800 text-white text-xs font-bold rounded-lg opacity-0 pointer-events-none group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all duration-200 whitespace-nowrap shadow-md z-50"
                    x-show="sidebarCollapsed" style="display:none;" x-cloak>Kebijakan Garansi</span>
            </a>
        @endcan
        ...
        @can('manage-settings')
            ...
            <a href="{{ route('admin.purchase.invoice.export') }}" wire:navigate
                ...
                <svg class="w-5 h-5 {{ request()->routeIs('admin.purchase.invoice.export') ? $activeIconClass : $inactiveIconClass }}"
                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <span x-show="!sidebarCollapsed" class="whitespace-nowrap transition-opacity">Import Purchase
                    Invoice</span><span
                    class="absolute left-full ml-4 px-3 py-1.5 bg-neutral-800 text-white text-xs font-bold rounded-lg opacity-0 pointer-events-none group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all duration-200 whitespace-nowrap shadow-md z-50"
                    x-show="sidebarCollapsed" style="display:none;" x-cloak>Import Purchase Invoice</span>
            </a>
            ...
            <a href="{{ route('admin.ai-assistant.index') }}" wire:navigate
                ...
                <svg class="w-5 h-5 {{ request()->routeIs('admin.ai-assistant.*') ? $activeIconClass : $inactiveIconClass }}"
                    fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.894 20.567L16.5 21.75l-.394-1.183a2.25 2.25 0 00-1.423-1.423L13.5 18.75l1.183-.394a2.25 2.25 0 001.423-1.423l.394-1.183.394 1.183a2.25 2.25 0 001.423 1.423l1.183.394-1.183.394a2.25 2.25 0 00-1.423 1.423z" />
                </svg>
                <span x-show="!sidebarCollapsed" class="whitespace-nowrap transition-opacity">AI Assistant</span><span
                    class="absolute left-full ml-4 px-3 py-1.5 bg-neutral-800 text-white text-xs font-bold rounded-lg opacity-0 pointer-events-none group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all duration-200 whitespace-nowrap shadow-md z-50"
                    x-show="sidebarCollapsed" style="display:none;" x-cloak>AI Assistant</span>
            </a>
        @endcan
    </nav>
