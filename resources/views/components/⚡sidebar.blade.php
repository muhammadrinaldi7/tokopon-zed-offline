...
<div>
    ...
    <nav
        ...
        @can('view-pos')
            {{-- POS --}}
            <a href="{{ route('zoffline.pos') }}" wire:navigate
                class="flex flex-col items-center justify-center w-14 h-full gap-1 {{ request()->is('zoffline/pos') ? 'text-[#4E44DB]' : 'text-gray-400 hover:text-[#4E44DB] transition-colors' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-auto" viewBox="0 0 24 24">
                    <path d="M0 0h24v24H0z" fill="none" />
                    <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="1.2">
        ...
        {{-- @can('trade-in')
            <a href="{{ route('zoffline.trade-in') }}" wire:navigate
                class="flex flex-col items-center justify-center w-14 h-full gap-1 text-gray-400 hover:text-emerald-600 transition-colors">
                <img src="{{ asset('assets/png/trd.png') }}" class="w-7 h-auto" alt="">
        ...
        @can('sell-phone')
            {{-- Jual HP --}}
            <a href="{{ route('zoffline.sell-phone') }}" wire:navigate
                class="flex flex-col items-center justify-center w-14 h-full gap-1 {{ request()->is('zoffline/sell-phone') ? 'text-violet-600' : 'text-gray-400 hover:text-violet-600 transition-colors' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-auto" viewBox="0 0 2048 2048">
                    <path d="M0 0h2048v2048H0z" fill="none" />
                    <path fill="currentColor"
                        d="M534 1664q-20 52-20 107v10q0 5 1 11H384v-128zm965 256h293v128H837l-147-148q-24-25-37-57t-13-67t13-67t38-58l813-814l538 539zm5-902l-389 390l357 358l389-390zm-187 902l65-64l-358-357l-242 242q-14 14-14 35t14 35l108 109zm-767 0q21 41 47 68t60 60H128q-27 0-50-10t-40-27t-28-41t-10-50V128q0-27 10-50t27-40t41-28t50-10h1024q27 0 50 10t40 27t28 41t10 50v752l-128 128V128H128v1792z" />
                </svg>
        ...
        @can('warranty-activation')
            {{-- Aktivasi Garansi --}}
            <a href="{{ route('zoffline.warranty-activation') }}" wire:navigate
                class="flex flex-col items-center justify-center w-14 h-full gap-1 {{ request()->routeIs('zoffline.warranty-activation') ? 'text-neutral-800' : 'text-gray-400 hover:text-neutral-800 transition-colors' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-auto" viewBox="0 0 24 24">
                    <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="1.5"
                        d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2M9 5a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2m-6 9l2 2l4-4" />
                </svg>
                <span class="text-[10px] font-medium">Garansi</span>
            </a>
        @endcan
        ...
        @can('view-stock')
            {{-- Cek Stock --}}
            <a href="{{ route('zoffline.cek-stock') }}" wire:navigate
                class="flex flex-col items-center justify-center w-14 h-full gap-1 {{ request()->routeIs('zoffline.cek-stock') ? 'text-violet-600' : 'text-gray-400 hover:text-violet-600 transition-colors' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-auto" viewBox="0 0 15 15">
                    <path d="M0 0h15v15H0z" fill="none" />
                    <path fill="none" stroke="currentColor" stroke-linejoin="round"
                        d="M.5 3.498L7.5.5l7 2.998m-14 0l7 2.998m-7-2.998V3.5m14-.002l-7 2.998m7-2.998V11.5l-7 3m7-11.002L7.5 6.5v8m0-8.004V14.5m0-8.004L.5 3.5m7 11l-7-3v-8" />
                </svg>
        ...
        @can('view-pos')
            {{-- Buka Shift --}}
            <a href="{{ route('zoffline.pos.open-shift') }}" wire:navigate
                class="flex flex-col items-center justify-center w-14 h-full gap-1 {{ request()->routeIs('zoffline.pos.open-shift') ? 'text-blue-600' : 'text-gray-400 hover:text-blue-600 transition-colors' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M8 11V7a4 4 0 118 0m-4 8v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2z" />
                </svg>
                <span class="text-[10px] font-medium">Buka Shift</span>
            </a>

            {{-- Closing Kasir --}}
            <a href="{{ route('zoffline.pos.closing-kasir') }}" wire:navigate
                class="flex flex-col items-center justify-center w-14 h-full gap-1 {{ request()->routeIs('zoffline.pos.closing-kasir') ? 'text-blue-600' : 'text-gray-400 hover:text-blue-600 transition-colors' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-auto" viewBox="0 0 16 16">
                    <path d="M0 0h16v16H0z" fill="none" />
                    <path fill="currentColor"
                        d="M12.5 2A2.5 2.5 0 0 1 15 4.5v10a.5.5 0 0 1-.686.464l-2.31-.926l-2.31.926a.5.5 0 0 1-.28.027l-.092-.027l-2.31-.926l-2.31.926a.5.5 0 0 1-.678-.378l-.007-.086V7.36l-.985-.328l-2.33.932a.5.5 0 0 1-.678-.378L.017 7.5v-3a2.5 2.5 0 0 1 2.5-2.5h10zm0 1h-8l.019.024c.303.413.482.923.482 1.48v9.26l1.81-.725a.5.5 0 0 1 .28-.027l.091.027l2.31.925l2.32-.925a.5.5 0 0 1 .28-.027l.092.027l1.81.725v-9.26c0-.78-.595-1.42-1.36-1.49l-.144-.007zm-3 6a.5.5 0 0 1 0 1h-3a.5.5 0 0 1 0-1zm3-2a.5.5 0 0 1 0 1h-6a.5.5 0 0 1 0-1zm-10-4l-.144.007a1.503 1.503 0 0 0-1.36 1.49v2.26l1.81-.725a.5.5 0 0 1 .258-.03l.086.02l.842.28v-1.81c0-.78-.595-1.42-1.36-1.49l-.144-.007zm10 2a.5.5 0 0 1 0 1h-6a.5.5 0 0 1 0-1z" />
                </svg>
                <span class="text-[10px] font-medium">Closing</span>
            </a>
        @endcan
