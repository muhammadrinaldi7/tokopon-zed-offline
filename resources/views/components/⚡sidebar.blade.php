...
<div>
    ...
    {{-- ==========================================
         ...
         ========================================== --}}
    <nav
        class="lg:hidden fixed bottom-0 left-0 w-full z-50 bg-white/90 backdrop-blur-lg border-t border-gray-100 flex items-center justify-around h-[72px] pb-2 px-2 shadow-[0_-10px_40px_rgba(0,0,0,0.05)]">
