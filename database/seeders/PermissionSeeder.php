...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $admin->syncPermissions([
            'view-pos', 'view-stock', 'manage-orders', 'manage-promos',
            'view-catalog-menu', 'manage-new-catalog', 'manage-second-catalog',
            'manage-categories', 'manage-brands', 'manage-accurate-products',
            'manage-accurate-customers', 'view-warehouse-stocks',
            'manage-trade-in', 'manage-buyback', 'manage-qc'
        ]);
        
        // CS gets chat, promo (optional), and stock view
        $cs->syncPermissions([
            'access-cs-chat', 'view-stock', 'manage-promos'
        ]);
